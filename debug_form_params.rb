...
# Script para debuggear los parámetros del formulario
require_relative 'config/environment'

puts "=== DEBUG FORM PARAMS ==="
...
if user
  ...
  if pdf_config
    ...
    # Simular parámetros exactos como los que vienen del formulario
    test_params = {
      "pdf_config" => {
        "footer_text" => "Texto de prueba debug #{Time.current.to_i}",
        "logo_url" => "https://res.cloudinary.com/cotalo/image/upload/v1754353935/pdf_logos/68/logo_real_1754353934.png",
